    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.CharField(default='--', max_length=100, verbose_name='地区')),
                ('type', models.CharField(default='--', max_length=100, verbose_name='种类')),
                ('dom', models.CharField(default='--', max_length=100, verbose_name='域名')),
                ('purl', models.URLField(default='--', max_length=100, verbose_name='链接网址')),
                ...
                ('address', models.CharField(default='--', max_length=100, verbose_name='施工地址')),
                ...
                ('crawltime', models.DateTimeField(auto_now_add=True, verbose_name='爬取时间')),
